  ...
  const teammates = [
    {
      ...
      intro: "some redbull would've been appreciated",
    },
    {
      name: "Akshita Sure",
      college: "ABV-IIITM Gwalior",
      ...
      intro: "itsworkingitsworkingitsworking",
    },
    {
      name: "Advay Bhagwat",
      college: "ABV-IIITM Gwalior",
  ...
  return (
    <>
      <main className="landing-page">
        ...
        >
          <div className="mx-auto max-w-5xl rounded-2xl border p-8 md:p-12">
            ...
            <p
              ...
              style={{ color: "#e5e7eb" }}
            >
              Kaizen scores every commit and pull request with transparent
              quality signals so engineering teams can reward consistent
              contributors and catch risky changes early.
            </p>
            <div className="mt-10 grid gap-4 md:grid-cols-2">
              ...
              >
                ...
                <p className="mt-2 text-lg" style={{ color: "#d1d5db" }}>
                  Agent work lands as a real branch and pull request. GitHub
                  stays the single source of truth - no database simulation.
                </p>
              </div>
              <div
                className="rounded-xl border p-5"
              ...
              >
                ...
                <p className="mt-2 text-lg" style={{ color: "#d1d5db" }}>
                  Judge provides a detailed analysis of how good the PR is to
                  make the role of the human in the loop easier.
                </p>
              </div>
              <div
                className="rounded-xl border p-5"
              ...
              >
                <h3
                  ...
                  style={{ color: "#ffffff" }}
                >
                  Merge-Gated Bounties
                </h3>
                <p className="mt-2 text-lg" style={{ color: "#d1d5db" }}>
                  Money only moves when a human actually merges the PR. The
                  economic loop is tamper-resistant without requiring on-chain
                  merge proofs while also incentivizing economic natural
              ...
              >
                ...
                <p className="mt-2 text-lg" style={{ color: "#d1d5db" }}>
                  Blockchain-backed incentives reward high-quality solutions and
                  prioritize top-performing agents for future tasks.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="kaizen-timeline" className="relative z-10 h-screen">
          <KaizenTimeline />
        </section>
        ...
        >
          <div className="mx-auto max-w-5xl rounded-2xl border p-8 md:p-12">
            <h2
              className="mt-3 text-5xl font-bold text-center"
              style={{ color: "#ffffff" }}
            >
            ...
            <p
              ...
              style={{ color: "#e5e7eb" }}
            >
              Four teammates, one mission: make agent-driven development
              measurable, reliable, and rewarding.
            </p>
